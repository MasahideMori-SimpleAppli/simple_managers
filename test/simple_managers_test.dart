...
void main() {
  group('FlagManager test', () {
    test('toDict and fromDict test', () {
      // normal test
      final FlagManager m = FlagManager();
      ...
      final FlagManager imDecoded = FlagManager();
  ...
  group('MultiFlagManager test', () {
    test('toDict and fromDict test', () {
      // normal test
      final MultiFlagManager m = MultiFlagManager();
      ...
      // jsonEncode and jsonDecode
      String t = jsonEncode(m.toDict());
      final MultiFlagManager imDecoded = MultiFlagManager();
      imDecoded.fromDict(jsonDecode(t));
  ...
  group('MultiIndexManager test', () {
    test('toDict and fromDict test', () {
      // normal test
      final MultiIndexManager im = MultiIndexManager();
      ...
      // jsonEncode and jsonDecode
      String t = jsonEncode(im.toDict());
      final MultiIndexManager imDecoded = MultiIndexManager();
      imDecoded.fromDict(jsonDecode(t));
  ...
  group('ValueManager test', () {
    test('toDict and fromDict test', () {
      // normal test
      final ValueManager m = ValueManager();
      ...
      // jsonEncode and jsonDecode
      String t = jsonEncode(m.toDict());
      final ValueManager imDecoded = ValueManager();
      imDecoded.fromDict(jsonDecode(t));
